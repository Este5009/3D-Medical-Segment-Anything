...
def main():
    ...
    config = load_json(ROOT / "configs/paper_style_level0_augmented.yaml")
    ...
    ck = torch.load(OUT / "checkpoints/best_paper_style_level0_augmented_decoder.pt", map_location="cpu", weights_only=False)
