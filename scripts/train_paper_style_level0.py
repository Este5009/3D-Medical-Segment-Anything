...
model-grid voxels) is replaced by PaperStyleLevel0OneQueryMaskDecoder's real
...
from models.query_mask_decoder import PaperStyleLevel0OneQueryMaskDecoder
...
from verify_paper_style_level0 import verify as run_pretraining_gates, EXPECTED_NOT_TRANSFERRED, EXPECTED_TRANSFERRED_COUNT

LEVELS = ("level0", "level1", "level2", "level3", "level4")
BASELINE_DECODER_PARAMETERS = 355889  # outputs/higher_resolution_true_level0's TrueFullResolutionLevel0OneQueryMaskDecoder param count is 182081; this is PaperStyleLevel0OneQueryMaskDecoder(level0_width=8)'s own param count, recorded post-hoc below for the real run.
...
def main():
    ...
    ap.add_argument("--config", default="configs/paper_style_level0.yaml")
    ...
    }, out / "checkpoints/best_paper_style_level0_decoder.pt")
