...
def main():
    ...
    config = load_json(ROOT / "configs/unetr_style_level0_full_width_augmented.yaml")
    ...
    ck = torch.load(OUT / "checkpoints/best_unetr_style_level0_full_width_augmented_decoder.pt", map_location="cpu", weights_only=False)
