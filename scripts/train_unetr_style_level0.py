...
from verify_unetr_style_level0 import verify as run_pretraining_gates, EXPECTED_NOT_TRANSFERRED, EXPECTED_TRANSFERRED_COUNT
...
def main():
    ...
    ap.add_argument("--config", default="configs/unetr_style_level0.yaml")
    ...
    }, out / "checkpoints/best_unetr_style_level0_decoder.pt")
