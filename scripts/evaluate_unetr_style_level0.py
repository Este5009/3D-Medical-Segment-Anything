...
def main():
    ...
    config = load_json(ROOT / "configs/unetr_style_level0.yaml")
    ...
    ck = torch.load(OUT / "checkpoints/best_unetr_style_level0_decoder.pt", map_location="cpu", weights_only=False)
