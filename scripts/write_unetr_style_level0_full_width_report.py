#!/usr/bin/env python3
"""Assemble outputs/unetr_style_level0_full_width_decoder/experiment_report.md from the
...
def main():
    ...
    lines.append(
        ...
        "`configs/unetr_style_level0_full_width.yaml` / this decoder's docstring for the on-machine timing measurements that "
        "set `level0_width=8`."
    )
