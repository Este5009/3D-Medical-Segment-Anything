#!/usr/bin/env python3
"""Assemble outputs/paper_style_level0_augmented_decoder/experiment_report.md from the
...
def main():
    ...
    lines.append(
        ...
        "(same architecture: `PaperStyleLevel0OneQueryMaskDecoder`, level0_width=32, matching "
    ...
    lines.append(
        ...
        "`configs/paper_style_level0_augmented.yaml` for exactly what augmentation was applied."
    )
