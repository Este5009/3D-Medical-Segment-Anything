...
change. The checkpoint was `outputs/mixed_domain_anatomical_training/checkpoints/best_mixed_domain.pt` and the recovered
configuration was `outputs/mixed_domain_anatomical_training/configuration.json`.
...
Across 677,073 post-filter error voxels:
...
- CAMRI: mean 0.022 mm, median 0.000 mm, P95 0.200 mm, maximum 1.000 mm
- Mouse: mean 0.041 mm, median 0.000 mm, P95 0.200 mm, maximum 1.625 mm
- Combined: mean 0.040 mm, median 0.000 mm, P95 0.200 mm, maximum 1.625 mm

Physical distances within the combined index-space bins:

- <=1 voxel: median 0.000 mm, P95 0.141 mm, maximum 1.000 mm
- >1 to 2 voxels: median 0.200 mm, P95 0.412 mm, maximum 0.800 mm
- >2 to 3 voxels: median 0.300 mm, P95 0.539 mm, maximum 0.990 mm
- >3 to 5 voxels: median 0.410 mm, P95 0.812 mm, maximum 1.063 mm
- >5 voxels: median 0.938 mm, P95 1.461 mm, maximum 1.625 mm
...
Combined residuals contain 161,543 FP and
515,530 FN voxels (FP/FN ratio
0.313); this is **under-segmentation (FN dominated)**.
...
and high-complexity regions. High-complexity regions have 1.533×
the combined errors per 100 surface voxels of relatively flat regions
(40.309 versus 26.294). This
...
magnitude is 5.889 z/mm at correctly localized surface regions and
8.294 z/mm at >2-voxel disagreement regions. Mean local
inside/outside contrast is 1.487 versus 0.738 z.
...
Within the expert-surface neighborhood, 41.72% of erroneous voxels
have probabilities in [0.25, 0.75], while 31.13% meet the fixed
...
96.01% of residual voxels are within one
index-space voxel of the expert surface and 3.99%
...
- CAMRI: Dice 0.9826, HD95
  0.133 mm, ASSD
  0.030 mm.
- Mouse: Dice 0.9657, HD95
  0.205 mm, ASSD
  0.046 mm.
