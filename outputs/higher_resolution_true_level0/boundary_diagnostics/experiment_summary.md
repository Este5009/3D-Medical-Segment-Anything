...
change. The checkpoint was `outputs/higher_resolution_true_level0/checkpoints/best_higher_resolution_true_level0.pt` and the recovered
configuration was `configs/higher_resolution_true_level0.yaml`.
...
Across 416,678 post-filter error voxels:
...
- CAMRI: mean 0.086 mm, median 0.000 mm, P95 0.200 mm, maximum 0.906 mm
- Mouse: mean 0.078 mm, median 0.100 mm, P95 0.283 mm, maximum 1.982 mm
- Combined: mean 0.078 mm, median 0.100 mm, P95 0.283 mm, maximum 1.982 mm

Physical distances within the combined index-space bins:

- <=1 voxel: median 0.070 mm, P95 0.200 mm, maximum 0.906 mm
- >1 to 2 voxels: median 0.200 mm, P95 0.424 mm, maximum 0.849 mm
- >2 to 3 voxels: median 0.300 mm, P95 0.806 mm, maximum 1.077 mm
- >3 to 5 voxels: median 0.510 mm, P95 1.237 mm, maximum 1.612 mm
- >5 voxels: median 0.900 mm, P95 1.802 mm, maximum 1.982 mm
...
Combined residuals contain 225,581 FP and
191,097 FN voxels (FP/FN ratio
1.180); this is **balanced**.
...
and high-complexity regions. High-complexity regions have 2.051×
the combined errors per 100 surface voxels of relatively flat regions
(28.382 versus 13.836). This
...
magnitude is 5.776 z/mm at correctly localized surface regions and
8.105 z/mm at >2-voxel disagreement regions. Mean local
inside/outside contrast is 1.489 versus 0.739 z.
...
Within the expert-surface neighborhood, 48.22% of erroneous voxels
have probabilities in [0.25, 0.75], while 24.33% meet the fixed
...
94.59% of residual voxels are within one
index-space voxel of the expert surface and 5.41%
...
- CAMRI: Dice 0.9888, HD95
  0.133 mm, ASSD
  0.018 mm.
- Mouse: Dice 0.9795, HD95
  0.115 mm, ASSD
  0.026 mm.
